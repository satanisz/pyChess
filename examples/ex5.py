...
rectangle2 = pygame.rect.Rect(
    tile_size + shift_x + 5, 2 * tile_size + shift_y + 5, piece_size, piece_size
)
rectangle1 = pygame.rect.Rect(
    5 * tile_size + shift_x + 5, 5 * tile_size + shift_y + 5, piece_size, piece_size
)
...
while running:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            and event.button == 1
            and rectangle1.collidepoint(event.pos)
        ):
        ...
        elif event.type == pygame.MOUSEMOTION and rectangle1_dragging:
            mouse_x, mouse_y = event.pos
